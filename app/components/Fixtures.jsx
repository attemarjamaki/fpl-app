  ...
  return (
    <>
      ...
      {fixtures.map((fixture, index) => (
        <div
          key={index}
          className="flex w-full mt-4 border-b border-neutral-700"
        >
            ...
            <div className="mt-2 mb-4">
              <div>
                {fixture.own_goals.away.map((ownGoal) => (
                  <div key={ownGoal.element} className="flex items-center mt-1">
              ...
              <div>
                {fixture.assists.home.map((assist) => (
                  <div key={assist.element} className="flex items-center mt-1">
                    <p className="flex items-center ml-auto font-semibold text-lg">
